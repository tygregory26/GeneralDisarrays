...
namespace FeatureInterface
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            Application.Run(mainPage.homeForm);
        }
    }
    ...
    public class MainWindow
    {
        ...
        public AccessoriesPage accForm;
        public SecurityPage securityForm;
        public CamerasPage camerasForm;
        ...
        public MainWindow()
        {
            ...
            accForm = new AccessoriesPage(this);
            securityForm = new SecurityPage(this);
            camerasForm = new CamerasPage(this);
        }
